...
## How This Repository Is Organised: Two Tiers

To keep the evidentiary weight of the governance work legible at a glance, documents are grouped into two clearly labelled tiers rather than left to blend together in one undifferentiated list.

### Tier 1 — Governance & Evidence-Based Protocols (Documents 1–9)

These documents make policy arguments, cite peer-reviewed research, treaty text, and institutional data, and are written for policy and institutional audiences — NPT delegates, AI safety researchers, diplomats, legislators. Claims here are meant to be checked, cited, and held to an evidentiary standard.

### Tier 2 — Reflective & Contemplative Practice (Documents 10–20)

These documents offer practices, frameworks, and inner-work tools for individuals and communities. Several draw on named contemplative teachers and traditions, credited individually in the index below, and are offered **as practice, not as scientific or policy claims**. Where a Tier 2 document draws on findings from neuroscience, physiology, or psychology, the source is cited; where it draws on the personal teaching of an individual practitioner, that is stated plainly rather than implied to carry the same evidentiary weight as Tier 1.
...
| 🧘 Practitioners of reflective or contemplative work | Documents 9, 17, 18, 19, 20 |
...
| 🕯️ Anyone building a daily grounding or centering practice | Documents 19, 20 |
| ⚖️ Anyone preparing for a high-stakes decision or negotiation | Document 20 → Document 9 |
...
| Build a daily invocation or centering practice | Doc 19 |
| Find stillness before a high-stakes decision | Doc 20 → Doc 9 |
...
A practical guide to finding and resting in the centre point between polarities — the pause between the in-breath and the out-breath — as a foundation for clear perception and coherent action. Connects personal stillness practice to the Council's broader argument for deliberate pauses in high-stakes governance, including AI-assisted nuclear decision-making.
*Source credit: Adapted from the teaching of Taoist Master San Qing (theway126.com). Adaptation only, in original language — no commercial offering of The Way 126 is endorsed by GSC.*
...
CHARTER (Doc 1)
    ...
    └── INNER WORK ─────────► Narrative Shift (10) ──► Field of Connection (11)
                               ...
                               ──► A Meditation and an Invocation (19) ──► The Still Point (20)
```
...
| Building a daily grounding practice | Doc 19 → Doc 20 → Doc 11 |
| Preparing for a high-stakes decision or negotiation | Doc 20 → Doc 9 → Doc 8 |
